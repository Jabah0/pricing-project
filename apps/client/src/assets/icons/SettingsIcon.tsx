...
export function SettingsIcon(props: JSX.IntrinsicElements["svg"]) {
  return (
    <svg
    ...
    >
      <defs>
        ...
        <mask id="lineMdCogFilled1">
          ...
          <g opacity="0">
            <use href="#lineMdCogFilled0" />
            <use href="#lineMdCogFilled0" transform="rotate(60 12 12)" />
            <use href="#lineMdCogFilled0" transform="rotate(120 12 12)" />
            <use href="#lineMdCogFilled0" transform="rotate(180 12 12)" />
            <use href="#lineMdCogFilled0" transform="rotate(240 12 12)" />
            <use href="#lineMdCogFilled0" transform="rotate(300 12 12)" />
